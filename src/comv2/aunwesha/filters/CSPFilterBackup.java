package comv2.aunwesha.filters;
 ...
 */
@WebFilter("/*")
public class CSPFilterBackup implements Filter {
...
// Loading policies for Frame and Sandboxing will be dynamically defined : We need to know if context use Frame
        ...
        cspPolicies.add("style-src " + originLocationRef + " 'unsafe-inline' 'unsafe-eval'");
        // --Define loading policies for Images
        cspPolicies.add("img-src " + originLocationRef + " 'unsafe-inline' 'unsafe-eval'");
