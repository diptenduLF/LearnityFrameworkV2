...
public class JSPGrid {
    ...
    public JSPGrid(int i1, int j1, HttpServletRequest request, String s1) {
        this.initGrid(i1, j1, request, s1);
    }

    public JSPGrid(int i1, int j1) {
        this.initGrid(i1, j1);
    }
    ...
    public void initGrid(int i1, int j1, HttpServletRequest request, String s1) {
        ...
        System.out.println("URI=="+this.t.getRequestURI());
        System.out.println("URL=="+this.t.getRequestURL());
        this._fldelse = s1;
    ...
    public JSPCol Cols(int i1) {
        return (JSPCol)this.y.elementAt(i1);
    }
    ...
    private void _mthif(int i1, int j1) {
        this.y = new Vector();
        for (int k1 = 0; k1 < i1; ++k1) {
            JSPCol jspcol = new JSPCol();
            jspcol._mthif(k1 + 1);
            jspcol.a(this._fldtry, this.f, this._mthint(k1));
            this.y.addElement(jspcol);
