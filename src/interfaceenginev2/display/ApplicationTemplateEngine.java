...
public class ApplicationTemplateEngine {
	...
	public static  Pair<String, String> retrieveTemplateIdAndComment(String interface_id_name){
		...
		if(GenericUtil.isEmptyString(templateexist) && GenericUtil.isEmptyString(defaultTemplateName)){
			templateComment="No template is mentioned. Default template is also not defined.";
		}
			...
			templateComment="Template is mentioned. But that template is not defined. Default template is also not defined.";
		}
			...
			templateComment="Template is mentioned. But that template is not defined. Default template is used. Template Name - "+defaultTemplateName;
		}else if(GenericUtil.hasString(templateexist)  && GenericUtil.hasString(templateIdPresnt)){
			templateComment="Template is mentioned. Template is defined. Template Name - "+templateexist;
		}else{
