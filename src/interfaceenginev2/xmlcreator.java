...
@WebServlet("/interfaceenginev2.xmlcreator") 
...
// 	  System.out.println("=============query_limit_start========="+query_limit_start);
	  ...
	  String[] namepairvalue = null;
	  namepairvalue = (String[])mysession.getAttribute("namepairvalue");
	  mysession.setAttribute("namepairvalueforexcel", namepairvalue);
...
//							System.out.println("multi_search_data==========="+multi_search_data);
					...
					//System.out.println("============if==========");
						...
						//System.out.println("=========after_group_by========"+after_group_by);
								...
								{
									int test2=modified_search_query.length();
									int test3=modified_search_query.lastIndexOf("order by");
									String before_order_by = modified_search_query.substring(0,modified_search_query.lastIndexOf("order by"));
...
//				System.out.println("===================count================"+count);
	...
	{
		e.printStackTrace();
		System.out.println("====Exception in xmlcreator====");

	}
	finally {	
		
//		mysession.removeAttribute("namepairvalue");		 
//		Moved to PortalServlet

//		String escapedData = StringEscapeUtils.escapeHtml4(d);
//	    out.write(escapedData.getBytes("UTF-8"));
...
public boolean isCacheRunning()
{
	...
	if(useGridCaching!=null && useGridCaching.equals("true") && cacheStatus.equals("STATUS_ALIVE"))
		flag = true;
	return flag;
}		
