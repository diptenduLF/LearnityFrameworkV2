...
public class LayoutUploader {
		...
		if (GenericUtil.isEmptyString(statusMessage)) {
			if (GenericUtil.hasString(type)) {
				if (type.equals(INTERFACE_COLLECTION_TYPE)) {
					...
					Pair<Boolean, String> returnStatus = uploadInterfaceDetail(attachmentname, attachmentname, s7, type, strSize, request, response,
							inlinecss, inlinejs, imagepath, loggedInUserId, isNew, interface_id);
			...
			try {
				...
				if (isSuccess) {
					...
					for (int ma = 0; ma < interface1.getLength(); ma++) {
						...
						String filePath = attachmentname + name + File.separator + name + File.separator + zip;

						System.out.println("Uploading interface:  " + interfaceid + "  from  " + filePath);
	...
	public static Pair<Boolean, String> uploadInterface(String htmlgeneratepath, String attachmentname, String s7, String typecollection,
		...
		returnStatus.setSecond("Uploading of interface started...");
		String interface_id = "";
		DOMParser parser = new DOMParser();
		String xmlpath = null;
		String name = null;
		...
		try {
			...
			if (isSuccess) {
				...
				if (nodelist.getLength() > 0) {
					...
					boolean isRoleExists = InterfaceRoleDao.checkRoleInerfaceAssociation(interface_id);
					if(isRoleExists) {
								...
								for (int s = 0; s < structure.getLength(); s++) {
									...
									for (int d = 0; d < part.getLength(); d++) {
										...
										for (int x = 0; x < optionitem.getLength(); x++) {
											...
											String eventname = x1.getAttribute("eventname");
											String eventvalue = x1.getAttribute("eventvalue");
											DataBaseLayer.insertOptionItem(interface_id, part_id, option_id, optionname, optionvalue, eventname, eventvalue);
										}
										// //////////////////////////////////////////////////////////////////////////////
										// FOR RADIO/// AND
										// CHECKBOX//////////////////////////////////////////////////////
										...
										for (int el = 0; el < elementitem.getLength(); el++) {
											...
											for (int x = 0; x < formoptionitem.getLength(); x++) {
												...
												String eventname = x1.getAttribute("eventname");
												String eventvalue = x1.getAttribute("eventvalue");
												DataBaseLayer.insertOptionItem(interface_id, element_id, option_id, optionname, optionvalue, eventname, eventvalue);
											}
											// //////////////////////////////////////////////////////////////////////////////
											// FOR RADIO IN FORM
											// ELEMENT//////////////////////////////////////////////////////
											...
											String autocomplete = e1.getAttribute("autocomplete");
											String multiple = e1.getAttribute("multiple");
											...
											DataBaseLayer.InsertDBFormElement(interface_id, part_id, element_id, element_class, element_type,
													...
													equaltomess, numbermess, emailmess, element_size, placeholder,autocomplete,multiple);
										}
										...
										for (int u = 0; u < selectoritem.getLength(); u++) {
											...
											String influencegridcolumn = u1.getAttribute("influencegridcolumn");
											...
											//String initialvalue = u1.getAttribute("initialvalue");
											//if((show_choose_one == null) || show_choose_one.equals(""))
											...
											DataBaseLayer.addSelecetor(interface_id, selector_id, selector_class, domaintype, value, gridrefresh,
													influence, part_id, contentid, behaviourid, show_choose_one, choose_one_label, choose_one_value, influencegridcolumn);
										}
										// //////////////////////////////////////////////////////////////////////////////////////SELECTOR
										// END//////////////////////////////////////////////////////////////////////////////
										// //////////////////////////////////////////////////////////////////////////////////
										...
										for (int x = 0; x < columnitem.getLength(); x++) {
											...
											String formatter = x1.getAttribute("formatter");
											String searchoptions = x1.getAttribute("searchoptions");
											...
											DataBaseLayer.setColModel(interface_id, part_id, col_head, col_name, col_index, col_width, col_editable,
													...
													custom, custom_func, default_type, default_value, formatter, searchoptions);
										}
										...
										String autoencode = e1.getAttribute("autoencode");
										String sortorder = e1.getAttribute("sortorder");
										String generateExcel = e1.getAttribute("generateExcel");
										...
										String showsearchboxonload = e1.getAttribute("showsearchboxonload");
										String searchboxtop = e1.getAttribute("searchboxtop");
										
										String customeditbutton = e1.getAttribute("CustomEditButton");
										String onselectrow = e1.getAttribute("onSelectRow");
										String autocomplete = e1.getAttribute("autocomplete");
										String multiple = e1.getAttribute("multiple");
										...
										Boolean searchOperators = GenericUtil.hasString(e1.getAttribute("searchOperators")) ? GenericUtil
												.convertStringToBoolean(e1.getAttribute("searchOperators")) : null;
										...
										GridProperty gridProperty = new GridProperty(altRows, autowidth, shrinkToFit, ignoreCase, rowNumbers, searchonEnter, altClass, 
												columnChooser, toolbarSearch, onselectrow, searchOperators);
										...
										DataBaseLayer.insertpart(interface_id, part_id, part_class, resize, border, cols, rows, scrolling, spacing,
												...
												customeditbutton, griddata, griddatatype, onPostInitFunction, gridProperty, autoencode, generateExcel,autocomplete,multiple,showsearchboxonload,searchboxtop);
						...
						returnStatus.setFirst(false);
						returnStatus.setSecond("'" + interface_id + "' - Role entry does not exist");
					}
				} else {
					returnStatus.setFirst(false);
								...
								for (int s = 0; s < structure.getLength(); s++) {
									...
									for (int d = 0; d < part.getLength(); d++) {
										...
										for (int x = 0; x < optionitem.getLength(); x++) {
											...
											String eventname = x1.getAttribute("eventname");
											String eventvalue = x1.getAttribute("eventvalue");
											DataBaseLayer.insertOptionItem(interface_id, interface_id + "_" + part_id, option_id, optionname, optionvalue, eventname, eventvalue);
										}
										// //////////////////////////////////////////////////////////////////////////////
										// FOR RADIO/// AND
										// CHECKBOX//////////////////////////////////////////////////////
										...
										for (int u = 0; u < selectoritem.getLength(); u++) {
											...
											DataBaseLayer.addSelecetor(interface_id, selector_id, selector_class, domaintype, value, gridrefresh,
													...
													choose_one_value,influencegridcolumn);
										}
										// //////////////////////////////////////////////////////////////////////////////////////SELECTOR
										// END//////////////////////////////////////////////////////////////////////////////
										// //////////////////////////////////////////////////////////////////////////////////
										...
										for (int x = 0; x < columnitem.getLength(); x++) {
											...
											for (int z = 0; z < edititem.getLength(); z++) {
												...
												DataBaseLayer.setEditOption(interface_id, interface_id + "_" + part_id, col_name, type, size, rows, cols,
														editdomaintype, value, multiple,imageAccessURL);
											}
											DataBaseLayer.setColModel(interface_id, interface_id + "_" + part_id, col_head, col_name, col_index,
													...
													col_email, col_number, custom, custom_func, default_type, default_value, formatter, searchoptions);
										}
										...
										DataBaseLayer.insertpart(interface_id, interface_id + "_" + part_id, part_class, resize, border, cols, rows,
												...
												multiplesearch, customeditbutton, griddata, griddatatype, onPostInitFunction, gridProperty, autoencode, generateExcel,autocomplete,multiple,showsearchboxonload,searchboxtop);
	...
	private static void UnZipInterface(String path, String filename) {
		...
		try {
			...
			System.out.println("Source zip file:  " + inFileName);
	...
	public static Pair<Boolean, String> uploadInterfaceDetail(String htmlgeneratepath, String attachmentname, String s7, String typecollection,
			String fsize, HttpServletRequest request, HttpServletResponse response, String inlinecss, String inlinejs, String imagepath,
			String loggedInUserId, boolean isNew, String selected_interface_id) {
		Pair<Boolean, String> returnStatus = new Pair<>();
		returnStatus.setFirst(false);
		returnStatus.setSecond("Uploading of interface started");
		String interface_id = "";
		...
		try {
			...
			if (isSuccess) {
				...
				if (nodelist.getLength() > 0) {
					Element e = (Element) nodelist.item(0);
					interface_id = e.getAttribute("id");
					if(selected_interface_id.equals(interface_id))
					{
						boolean isRoleExists = InterfaceRoleDao.checkRoleInerfaceAssociation(interface_id);
						if(isRoleExists) {
							boolean isExist = ManifestDao.checkManifestAssociation(interface_id);
						...
						returnStatus.setFirst(false);
						returnStatus.setSecond("You have selected '" + selected_interface_id + "' but uploaded interface for '" + interface_id);
					}
				} else {
					returnStatus.setFirst(false);
					returnStatus.setSecond("No data found!");
