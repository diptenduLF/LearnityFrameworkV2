...
public class SchemaValidatation {
	...
	public static Pair<Boolean, String> validateScxmlXml(ServletContext servletContext, String xmlPath) {
		return validateXML(servletContext, XSDPath.SCXML_XSD.getSchemaPath(), xmlPath);
	}
	
	public static Pair<Boolean, String> validateCustomComponentXml(ServletContext servletContext, String xmlPath) {
		return validateXML(servletContext, XSDPath.CUSTOMCOMPONENT_XSD.getSchemaPath(), xmlPath);
	}
