...
public class Host
{
    ...
    private static String contentFolderMappedURL;
    ...
    public static void setWordNetPath(final String wordnetpath) {
        Host.WordNetPath = wordnetpath;
    }
    ...
    public static void setContentFolderMappedURL(final String contentFolderMappedURL) {
        Host.contentFolderMappedURL = contentFolderMappedURL;
    }
    ...
    public static String getContentFolderMappedURL() {
        return Host.contentFolderMappedURL;
    }
    ...
    static {
        ...
        Host.RTEPath = null;
        Host.contentFolderMappedURL = null;
    }
}
