...
public class InitHostInfo extends HttpServlet
{
    ...
    public void init(final ServletConfig servletConfig) throws ServletException {
        ...
        final String wordnetpath = servletConfig.getInitParameter("WordNetPath");
        ...
        final String strContentFolderMappedURL = servletConfig.getInitParameter("ContentFolderMappedURL");
        Host.setAdminPath(adminpath);
        Host.setWordNetPath(wordnetpath);
        ...
        Host.setContentFolderMappedURL(strContentFolderMappedURL);
